...
def intro():
    ...
    st.sidebar.success("Select a 1-B-I-M demo above.")

    st.markdown(
        """
        projject 1B-I-M is an internal Machine Learning and Datasciene framework built specifically for
        realtime query on real estate data for the purpose of finding unrealized hyper growth land redevelopment.

        **👈 Select a demo from the dropdown on the left** to see some examples
        of what 1B-I-M can do!
